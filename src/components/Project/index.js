...
const Project = () => {
    ...
    <VStack w="23rem" align='left' paddingLeft={1}>
        <Image src={project.image} alt={project.alt} objectFit='contain' p={8} h='250px' objectPosition='center'/>
            <Text fontSize='2xl' align='left'>{project.name}</Text>
